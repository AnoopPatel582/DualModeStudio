    ...
    <section className="relative w-full py-10">
      <div className="relative z-10 mx-auto max-w-[1200px] px-6">
        ...
        {/* <div className="text-center mb-16">
          <h2 className={`${syne.className} text-4xl md:text-5xl font-semibold text-white leading-tight`}>
            Are You Currently
            <br />
            Struggling With?
          </h2>
...
<div className="text-center mb-16">
  <h1
    className={`${syne.className} text-5xl md:text-6xl font-bold text-white leading-tight inline-block px-24 py-6 rounded-3xl`}
    style={{
  ...
  >
    ...
    Struggling With?
        ...
        <div className="mt-16 text-center">
          <h3 className={`${syne.className} text-3xl md:text-4xl font-semibold text-white mb-8`}>
            That's Exactly Why We Exist.
          </h3>
